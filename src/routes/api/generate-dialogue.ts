...
انطق النص كما هو حرفياً دون أي مقدمات أو أسماء متحدثين، ودون حذف أو اختصار أو إضافة.`;
  ...
  return `حوّل النص إلى صوت باللهجة العامية السعودية البسيطة، وكأن شخصًا يتكلم مع شخص ثاني بشكل طبيعي وعفوي.

- لا تستخدم أسلوباً رسمياً أو فصيحاً، ولا تجعل القراءة بطيئة أو مسرحية.
- النبرة واقعية، واضحة، وسلسة، بإيقاع طبيعي متوسط (لا بطيء ولا مسرِع).
- أضف وقفات قصيرة وطبيعية بين الجمل فقط، بدون مبالغة ولا صمت طويل.
- انطق الأسماء والكلمات المشكّلة بدقة كما وردت في النص.
- لا تغيّر معنى النص، ولا تحذف ولا تضيف أي كلمة.
- اقرأ كلمتي «المذيع» و«المحصّل» عند بداية كل دور، مع تغيير بسيط في نبرة الصوت بين الشخصيتين ليتضح الفرق دون تمثيل زائد.
- أي كلمة فصيحة داخل النص انطقها بمقابلها العامي السعودي البسيط مع نفس المعنى.

${roleLine}
انطق النص التالي كما هو مباشرة:`;
}
