...
انطق النص كما هو حرفياً دون أي مقدمات أو أسماء متحدثين، ودون حذف أو اختصار أو إضافة.`;
  ...
  const roleLine =
    role === "host"
      ? "أنت المذيع. ابدأ بنطق كلمة «المذيع» بنبرة واثقة وودودة قليلاً أعلى، ثم أكمل النص بصوت طبيعي وسلس."
      : "أنت المحصّل. ابدأ بنطق كلمة «المحصّل» بنبرة هادئة ومباشرة أخفض قليلاً، ثم أكمل النص بصوت طبيعي وسلس.";

  return `تكلم باللهجة السعودية العامية البسيطة 100٪ كأنك تدردش مع صاحبك، وبإيقاع سريع وطبيعي يشد الانتباه.

- ممنوع منعاً باتاً استخدام اللغة العربية الفصحى أو أي نبرة رسمية أو خطابية أو مسرحية. أي كلمة فصيحة حوّلها فوراً لمقابلها العامي السعودي بنفس المعنى.
- الإيقاع سريع وحيوي (ليس بطيئاً أبداً)، بدون مطّ في الحروف ولا صمت طويل بين الجمل.
- النبرة عفوية وطبيعية جداً، كأنها مكالمة يومية بين شخصين، مع تغيير بسيط ومحسوس في نبرة الصوت بين المذيع والمحصّل.
- وقفات قصيرة وطبيعية فقط بين الجمل، وبدون تمثيل زائد ولا تفخيم.
- انطق الأسماء والكلمات المشكّلة بدقة كما وردت.
- لا تغيّر معنى النص، ولا تحذف ولا تضيف أي كلمة.
- اقرأ كلمتي «المذيع» و«المحصّل» عند بداية كل دور بشكل طبيعي وسريع.

${roleLine}
انطق النص التالي كما هو مباشرة وبإيقاع سريع وعامي:`;
}
